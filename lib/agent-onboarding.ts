...
export const AGENT_API_ENDPOINTS: ReadonlyArray<AgentApiEndpointDefinition> = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Following a source reference is a separate read: task and task-comment routes require task:read, so an attention:read-only credential gets 403 on them.",
  ...
  },
  {
    ...
    notes: [
      ...
      "Following a source reference is a separate read: task and meeting-note routes require task:read, so an attention:read-only credential gets 403 on them.",
...
export function buildAgentAttentionExample(): string {
  return [
    ...
    `  -H "Authorization: Bearer $${AGENT_BEARER_TOKEN_ENV_NAME}"`,
    "",
    "# 5. Follow the source reference before acting on an item. These source",
    "#    reads need task:read on top of attention:read; an attention-only",
    "#    credential gets 403 and should work from the item summary instead:",
        ...
        AttachmentRecord: {
          ...
          properties: {
            ...
            commentId: {
              type: ["string", "null"],
              description:
                "The task comment that owns this attachment, or null for a task-level attachment.",
            },
        ...
        TaskCommentRecord: {
          ...
          properties: {
            ...
            attachments: {
              ...
              description: "File attachments owned by this comment.",
            },
          },
        },
        ...
        TaskCommentCreateRequest: {
          ...
          properties: {
            ...
            attachmentIds: {
              ...
              items: { type: "string" },
              description:
                "Task file attachment ids uploaded by the caller and not already assigned to a comment.",
            },
