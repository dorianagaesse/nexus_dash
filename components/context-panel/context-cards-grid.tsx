    ...
    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
      {cards.map((card) => {
        ...
        return (
          <article
            key={card.id}
            className="flex h-[240px] cursor-pointer flex-col overflow-hidden rounded-2xl border p-3 transition duration-150 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_-18px_rgba(15,23,42,0.45)] hover:ring-2 hover:ring-slate-900/10"
