  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "app/api/projects/[projectId]/tasks/search/route.ts",
        "components/kanban/kanban-filter-toolbar.tsx",
        "components/kanban/kanban-filter-utils.ts",
        "components/kanban/use-kanban-task-search.ts",
        ...
        "lib/task-label.ts",
        "lib/task-status.ts",
        "lib/services/project-task-search-service.ts",
      ],
      thresholds: {
        lines: 85,
        branches: 80,
