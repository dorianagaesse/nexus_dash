-- Expose project actor display metadata to every current project member without
-- granting direct access to secret-bearing ApiCredential rows.

CREATE OR REPLACE FUNCTION app.list_project_actors(target_project_id TEXT)
RETURNS TABLE (
  "kind" TEXT,
  "actorId" TEXT,
  "name" TEXT,
...
REVOKE ALL ON FUNCTION app.list_project_actors(TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION app.list_project_actors(TEXT) TO PUBLIC;
